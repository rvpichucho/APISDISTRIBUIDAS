<div class="md:w-auto">
    ...
    <div class="mt'20">
        <div class="bg-gray-200 border-l-4 border-purple-600 w-full shadow rounded p-8 sm:p-12 -mt-72">
            <p class="text-3xl text-purple-600 font-bold leading-7 text-center">Cálculo diferencia de la Altura</p>
            ...
            <form action="" method="post">
                <div class="md:flex items-center mt-12">
                    ...
                    <div class="w-full md:w-1/2 flex flex-col">
                        <label class="font-semibold leading-none">Ángulo</label>
                        <div class="flex mt-4">
                            ...
                            <input type="number" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 bg-gray-100 border-gray-200 outline-none focus:border-indigo-500" wire:model="angle">
                        </div> 
                    </div>
